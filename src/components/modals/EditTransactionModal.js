...
export default function EditTransactionModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-sm" style={{ backgroundColor: 'var(--modal-overlay)' }}>
      <div className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-2xl border p-5 shadow-2xl transition-colors duration-300 sm:p-8" style={{ backgroundColor: 'var(--modal-bg)', borderColor: 'var(--card-border)' }}>
        <h3 className="mb-4 text-xl font-semibold sm:mb-6 sm:text-2xl" style={{ color: 'var(--foreground)' }}>Edit Transaction</h3>
